...
This app creates the sitemap.xml file for your site. It has setting for the main tags of sitemap (  <code><loc></code>  , <lastmod> and <priority>). Priority tag has the default value of 0.5. App's features can be extended based on your request. 
